...
public abstract class Part implements Serializable {
    ...
    int inv;
    @Min(value = 0, message = "Minimum inventory size value must be at or above zero")
    int minInv;
    @Max(value = 1000, message = "Maximum inventory size value must be at or below one thousand")
    int maxInv;
